...
scripts/compose/ingest.sh statutes       # golden_questions.yaml expects the seeded statutes present
scripts/seed/seed-demo-users.sh       # POST /auth/register is disabled -- the harness logs in as
